...
import Diff from "../../components/mdx/Digff.astro";
...
First you need to create an `mdx` file, which is as simple as changing the extension to `.mdx`. GOT✔
...
<Collapse title="This is an example text.">
  This is the hidden content! see i m here.
</Collapse>
